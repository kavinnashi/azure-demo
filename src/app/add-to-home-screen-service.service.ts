...
export class AddToHomeScreenServiceService {
  ...
  public showPrompt() {
    if (this.deferredPrompt) {
      ...
      this.deferredPrompt.userChoice.then((choiceResult: { outcome: string; userChoice: any; }) => {
      ...
      public sendToAnalytics(userChoice: any) {
